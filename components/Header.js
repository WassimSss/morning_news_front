...
import { removeHiddenArticleAll } from '../reducers/hiddenArticles'
...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morning-news-front-syzf.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morning-news-front-syzf.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	const displayAllHiddenArticles = () => {
		dispatch(removeHiddenArticleAll())
	}
	...
	return (
		<header className={styles.header}>
			<div className={styles.logoContainer}>
				...
				<FontAwesomeIcon onClick={() => displayAllHiddenArticles()} icon={faEye} className={styles.logoutSection} />
				{userSection}
			</div>
